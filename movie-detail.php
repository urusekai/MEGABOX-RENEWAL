                        ...
                        <h3 class="ko-title">주토피아 2</h2>
                            ...
                            <p class="movie-meta">
                                <span class="date">2025.11.26</span><span class="seperator">|</span><span
                                    class="runtime">108분</span><span class="seperator">|</span><span
                                    class="rating all">전체관람가</span>
                            </p>
        ...
        <section id="movie-detail" class="tab-section">
            <div class="inner">
                        ...
                        <ul class="swiper-wrapper">
                            <li class="swiper-slide" data-video-src="./assets/videos/주토피아-예고편-1.mp4">
                                <div class="thumb">
                                    ...
                                    <svg class="play-icon" xmlns="http://www.w3.org/2000/svg" id="Layer_1"
                ...
                <div class="still">
                    ...
                    <button type="button" class="still-more-btn">더보기<svg xmlns="http://www.w3.org/2000/svg"
                            id="arrow-circle-down" viewBox="0 0 24 24" width="512" height="512">
                            <path
